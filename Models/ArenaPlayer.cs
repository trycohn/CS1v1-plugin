...
public class ArenaPlayer
{
    ...
    public void ResetPlayerWeapons(RoundType roundType)
    {
        ...
        if (!PlayerController.IsValid || !PlayerController.PlayerPawn.IsValid) return;
        ...
        {
            if (!weapon.IsValid || weapon.Value == null || !weapon.Value.IsValid || weapon.Value.DesignerName == knifeName) continue;
